...
static void
_outProjectionInfo(StringInfo str, const ProjectionInfo *node)
{
	WRITE_NODE_TYPE("PROJECTIONINFO");

	WRITE_NODE_FIELD(pi_targetlist);
	WRITE_INT_FIELD(pi_numSimpleVars);
	WRITE_INT_FIELD(pi_lastInnerVar);
	WRITE_INT_FIELD(pi_lastOuterVar);
	WRITE_INT_FIELD(pi_lastScanVar);
}
...
static void
_outDrillBeyond(StringInfo str, const DrillBeyond *node)
{
	WRITE_NODE_TYPE("DRILLBEYOND");

	_outJoinPlanInfo(str, (const Join *) node);
}

static void
_outDrillBeyondExpand(StringInfo str, const DrillBeyondExpand *node)
{
	WRITE_NODE_TYPE("DRILLBEYONDEXPAND");

	_outPlanInfo(str, (const Plan *) node);
}

static void
_outDrillBeyondDummy(StringInfo str, const DrillBeyondDummy *node)
{
	WRITE_NODE_TYPE("DRILLBEYONDDUMMY");
...
static void
_outDrillBeyondPath(StringInfo str, const DrillBeyondPath *node)
{
	WRITE_NODE_TYPE("DRILLBEYONDPATH");

	_outJoinPathInfo(str, (const JoinPath *) node);
}

static void
_outDrillBeyondDummyPath(StringInfo str, const DrillBeyondDummyPath *node)
{
	WRITE_NODE_TYPE("DRILLBEYONDDUMMYPATH");
	...
	else
	{
		...
		switch (nodeTag(obj))
		{
			...
			case T_HashJoin:
				...
				break;
			case T_DrillBeyond:
				_outDrillBeyond(str, obj);
				break;
			case T_DrillBeyondExpand:
				_outDrillBeyondExpand(str, obj);
				break;
			case T_DrillBeyondDummy:
				_outDrillBeyondDummy(str, obj);
				break;
			case T_Agg:
				_outAgg(str, obj);
				break;
			...
			case T_HashPath:
				...
				break;
			case T_DrillBeyondPath:
				_outDrillBeyondPath(str, obj);
				break;
			case T_DrillBeyondDummyPath:
				_outDrillBeyondDummyPath(str, obj);
				break;
