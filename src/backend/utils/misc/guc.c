...
static struct config_bool ConfigureNamesBool[] =
{
	...
	// drb optimizations
	{
        {"drb_enable_static_reoptimization", PGC_USERSET, CUSTOM_OPTIONS,
            gettext_noop("Enable/disable static selectivity planning in reoptimization")
        },
        &drb_enable_static_reoptimization,
        false,
        NULL, NULL, NULL
    },
	{
        {"drb_enable_preselection", PGC_USERSET, CUSTOM_OPTIONS,
            gettext_noop("Enable/disable preselection of k-intersection")
        },
        &drb_enable_preselection,
        false,
        NULL, NULL, NULL
    },
	{
        {"drb_enable_reoptimization", PGC_USERSET, CUSTOM_OPTIONS,
            gettext_noop("Enable/disable runtime reoptimization")
        },
        &drb_enable_reoptimization,
        false,
        NULL, NULL, NULL
    },
	{
        {"drb_enable_dynamic_omega", PGC_USERSET, CUSTOM_OPTIONS,
            gettext_noop("Enable/disable dynamic switch between placeholder & default strategy.")
        },
        &drb_enable_dynamic_omega,
        false,
        NULL, NULL, NULL
    },
	{
        {"drb_enable_rea", PGC_USERSET, CUSTOM_OPTIONS,
            gettext_noop("Enable/disable full REA as entity augmentation backend (disabled=random values).")
        },
        &drb_enable_rea,
        false,
        NULL, NULL, NULL
   ...
   {
        {"drb_enable_selectivity_estimation", PGC_USERSET, CUSTOM_OPTIONS,
            gettext_noop("Enable/disable selectivity estimation probe queries")
        },
        &drb_enable_selectivity_estimation,
        false,
        NULL, NULL, NULL
   },
   {
        {"drb_enable_force_big_omega_before_agg", PGC_USERSET, CUSTOM_OPTIONS,
            gettext_noop("Enable/disable forcing of big omega directly before agg")
        },
        &drb_enable_force_big_omega_before_agg,
        false,
        NULL, NULL, NULL
   },
   {
        {"drb_enable_pull_up_projection", PGC_USERSET, CUSTOM_OPTIONS,
            gettext_noop("Enable/disable projection pull")
        },
        &drb_enable_pull_up_projection,
        false,
        NULL, NULL, NULL
   },
   {
        {"drb_enable_send_predicates", PGC_USERSET, CUSTOM_OPTIONS,
            gettext_noop("Enable/disable predicate push to augmentation")
        },
        &drb_enable_send_predicates,
        true,
        NULL, NULL, NULL
   },
   {
        {"drb_enable_pull_up_selection", PGC_USERSET, CUSTOM_OPTIONS,
            gettext_noop("Enable/disable selection pull up")
        },
        &drb_enable_pull_up_selection,
        false,
        NULL, NULL, NULL
   },
   {
        {"drb_enable_send_isnumeric_constraint", PGC_USERSET, CUSTOM_OPTIONS,
            gettext_noop("Enable/disable sending of isNumeric() constraint to the backend")
        },
        &drb_enable_send_isnumeric_constraint,
        false,
        NULL, NULL, NULL
   },
   {
        {"drb_enable_basic_cache", PGC_USERSET, CUSTOM_OPTIONS,
            gettext_noop("Enable/disable mat node beneath DrillBeyond node")
        },
        &drb_enable_basic_cache,
        true,
        NULL, NULL, NULL
    },
    {
        {"drb_enable_rewind_cache", PGC_USERSET, CUSTOM_OPTIONS,
            gettext_noop("Enable/disable rewind cache for drillbeyond")
        },
        &drb_enable_rewind_cache,
        true,
        NULL, NULL, NULL
    },
    {
        {"drb_enable_additional_cache", PGC_USERSET, CUSTOM_OPTIONS,
            gettext_noop("Enable/disable additional cache nodes for drillbeyond")
        },
        &drb_enable_additional_cache,
        true,
        NULL, NULL, NULL
    },
    {
        {"drb_enable_big_omega", PGC_USERSET, CUSTOM_OPTIONS,
            gettext_noop("Enable/disable split omega operator for drillbeyond")
        },
        &drb_enable_big_omega,
        false,
        NULL, NULL, NULL
    },
	{
...
{
	{
		{"drb_cost_model", PGC_USERSET, CUSTOM_OPTIONS,
			gettext_noop("Cost model used for the DRB operator: 1: -k +s, 2: -k -s, 3: +k, -s, 4: +k +s")
		},
		&drb_cost_model,
		1, // default: 1 is only_s
		1, 4, //min 1 max 4  (see drillbeyond.h)
		NULL, NULL, NULL
	},
	{
		{"drb_max_num_cands", PGC_USERSET, CUSTOM_OPTIONS,
			gettext_noop("Maximum number of candidates to request from DrillBeyond")
		},
		&drb_max_num_cands,
		1, 1, INT_MAX / 2,
		NULL, NULL, NULL
...
{
    {
        {"drb_fixed_cost", PGC_USERSET, CUSTOM_OPTIONS,
            gettext_noop("Fixed cost for the DrillBeyond operator (testing)")
        },
        &drb_fixed_cost,
        -1, -1, INT_MAX / 2,
        NULL, NULL, NULL
    ...
    {
        {"drb_run_cost", PGC_USERSET, CUSTOM_OPTIONS,
            gettext_noop("Run cost for the DrillBeyond operator")
        },
        &drb_run_cost,
        -1, -1, INT_MAX / 2,
        NULL, NULL, NULL
    ...
    {
        {"drb_startup_cost", PGC_USERSET, CUSTOM_OPTIONS,
            gettext_noop("Startup cost for the DrillBeyond operator")
        },
        &drb_startup_cost,
        -1, -1, INT_MAX / 2,
        NULL, NULL, NULL
    ...
    {
        {"drb_selectivity", PGC_USERSET, CUSTOM_OPTIONS,
            gettext_noop("Fake global selectivity for DrillBeyond")
        },
        &drb_selectivity,
        DBL_MAX, 0, DBL_MAX,
        NULL, NULL, NULL
