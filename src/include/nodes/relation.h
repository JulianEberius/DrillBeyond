...
typedef struct PlannerInfo
{
	...
	/* drillbeyond */
	List	   *drb_expansions;	/*  drillbeyond-expansions*/
	List	   *drb_all_expansions;	/*  drillbeyond-expansions*/
} PlannerInfo;
...
typedef struct RelOptInfo
{
	...
	// Relids		drillBeyond_dependencies;			/* the relations that have to appear before this drillbeyond relation */
	// char		*drillBeyond_keyword; /*keyword query that this drillbeyond relopt encapsulates*/
} RelOptInfo;
...
/*
 * A DrillBeyond path needs no special fields.
 */
typedef struct DrillBeyondPath {
	JoinPath jpath;
	Oid extended_rel_oid;
	struct DrillBeyondExpansion *drb_expansion;
} DrillBeyondPath;

typedef struct DrillBeyondDummyPath
{
	Path path;
} DrillBeyondDummyPath;
